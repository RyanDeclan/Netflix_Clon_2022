...
import { getTopLated, getTvOnAir, ITvOnAir, ITvTopRated } from "../../api";
...
function TvOnAir() {
  const { data, isLoading } = useQuery<ITvOnAir>(
    ["TV", "OnAir"],
    async () => await getTvOnAir(),
    {
  ...
  return (
    <>
      <UpComingTitle>방영중인 프로그램</UpComingTitle>
      <Wrapper>
        <motion.svg
          whileHover="hover"
          initial="normal"
